# Joe Reant — Personal Portfolio Website
...
Untuk membuka dan melihat website ini di komputer lokal Anda:

1. Clone repositori ini:
   ```bash
   git clone https://github.com/joereant/porto-landing.git
   ```
2. Masuk ke direktori project:
   ```bash
   cd porto-landing
   ```
3. Buka file `index.html` langsung di browser Anda, atau gunakan ekstensi editor seperti **Live Server** di VS Code untuk hasil terbaik.
